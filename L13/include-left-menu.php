...
?>
  ...
  <div id="leftPan">
  	<ul class="one">
		...
		<li class="<?php echo select('Project') ?>"><a href="project.php?menu=Project">Project</a></li>
		<li class="<?php echo select('ProjectAndPeople') ?>"><a href="projectAndPeople.php?menu=ProjectAndPeople">ProjectAndPeople</a></li>
