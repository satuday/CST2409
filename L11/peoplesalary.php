...
<div id="mainPan">   
  ...
  <div id="rightPan">
    ...
    <div id="bodyPan">
	    ...
	    $sql = "select firstName, lastName,  description,  currentSalary, salaryrange2,  gender from title inner join People on title.titleid = People.titleid";
	   ...
	   ?>
		...
		<?php
            ...
            while($row = mysqli_fetch_array($result)){
               ...
               $gender = $row['gender'] == "F" ? "Ms.":"Mr.";
                
                $salary = (int)($row['currentSalary']/1000);
                $salary2 = (int)($row['salaryrange2']/1000); 
                
                $str = $gender . $lastName . ", " .  $firstNamt . " " . $salary . "K " . $title;
